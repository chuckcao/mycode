package tempLRecyclerView.view;
...
import tempLRecyclerView.interfaces.IRefreshHeader;
import tempLRecyclerView.progressindicator.AVLoadingIndicatorView;
import tempLRecyclerView.recyclerview.ProgressStyle;
...
public class ArrowRefreshHeader extends LinearLayout implements IRefreshHeader {
    ...
    private void initView() {
        ...
        mContainer = (LinearLayout) LayoutInflater.from(getContext()).inflate(R.layout.lr_listview_header, null);
    ...
    private View initIndicatorView(int style) {
        AVLoadingIndicatorView progressView = (AVLoadingIndicatorView) LayoutInflater.from(getContext()).inflate(R.layout.lr_layout_indicator_view, null);
